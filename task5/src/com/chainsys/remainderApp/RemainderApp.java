...
public class RemainderApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Height(in meters) :" + input.getHeight());
		System.out.println("Weight(in kilograms) :" + input.getWeight());
		System.out.println("--------------------------------------");
...
System.out.println("1.Are you want to Weight Loss\n2.Are you want to Gain Weight");
