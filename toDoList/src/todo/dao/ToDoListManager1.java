...
public interface  ToDoListManager1 {
    ...
    void addTask1(String managerUsername, String managerPassword,int taskId, String task, Date dueDate, String employeeName)throws SQLException;

    void deleteTask(int taskId) throws SQLException;

    void updateTask( int taskId, String newTask, Date newDueDate, String newEmployeeName) throws SQLException;
