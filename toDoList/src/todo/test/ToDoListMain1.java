...
public class ToDoListMain1 {
    ...
    static void managerRegistration(Scanner scanner, ToDoListManager1 manager, ToDoItem1 task1) throws SQLException {
        ...
        if (manager.signUp(managerUsername, managerPassword)) {
            manager.addTask1(managerUsername, managerPassword, task1.getTaskId(), task1.getTask(),
                    task1.getDueDate(), task1.getEmployeeName());
    ...
    static void managerTasks(Scanner scanner, ToDoListManager1 manager, ToDoItem1 todo) throws SQLException, ParseException {
        Validation validate = new Validation();
