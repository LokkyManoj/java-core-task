...
//
//	public ToDoListMain1() throws ClassNotFoundException, SQLException {
...
//				switch (choice) {
//				case 1:
//					managerRegistration(scanner, manager,task1);
//					break;
//				case 3:
//					employeeLogin(scanner, manager,task1);
//					break;
//				case 4:
//					exit = true;
//					break;
...
//			manager.addTask(managerUsername, managerPassword, task1.getTask(), task1.getDueDate(), task1.getEmployeeName());
//		}
//	}
//
//	static void employeeLogin(Scanner scanner, ToDoListManager1 manager,ToDoItem1 task1) throws SQLException, ClassNotFoundException {
//		//ToDoItem1 task1 = new ToDoItem1();
//		SimpleToDoListManager1 manage = new SimpleToDoListManager1();
...
//		String managerUsername = scanner.nextLine();
//		
//		manage.getEmployeeDetails(managerUsername,employeeUsername);
//
//	}
//}
